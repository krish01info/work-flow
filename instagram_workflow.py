...
1080x1920 video with karaoke captions, uploads to Google Drive (for hosting),
then publishes as an Instagram Reel via the Meta Graph API.

Run:  python instagram_workflow.py
"""
...
# ---------------------------------------------------------------------------
# Node 5 — upload_to_drive (hosts video for Instagram)
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    for key in ("trending_song_title", "trending_song_artist",
                "final_video_path", "drive_url", "instagram_url"):
